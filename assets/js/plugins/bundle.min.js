    ...
    return class {
        ...
        _create(e) {
            ...
            this._parent = new t(s), this._select = new t("div", {
                ...
                class: i.dropdown
            }), this._config.multiple && this._select.addClass(i.multiselect), this._options = this._generateOptions(), this._select.addEventListener("click", this._boundHandleClick), this._select.append(this._label.get()), this._select.append(this._optionsWrapper.get()), this._parent.append(this._select.get()), this._placeholder = new t("span", {
                class: i.placeholder,
        ...
        _handleClick(e) {
            if (e.stopPropagation(), e.target.className !== i.autocompleteInput) {
                if (this._state.opened) {
                    const t = this._options.find(t => t.get() === e.target);
                    return t && this._setValue(t.get().getAttribute("data-value"), !0), this._select.removeClass(i.dropdownShown), this._body.removeEventListener("click", this._boundHandleClick), this._select.addEventListener("click", this._boundHandleClick), void(this._state.opened = !1)
                }
                e.target.className !== this._config.icon && (this._select.addClass(i.dropdownShown), this._body.addEventListener("click", this._boundHandleClick), this._select.removeEventListener("click", this._boundHandleClick), this._state.opened = !0, this._autocomplete && this._autocomplete.focus())
            }
        }
        _setValue(e, t, s) {
            if (e && !s && (this._config.value = this._config.multiple ? [...this._config.value || [], e] : e), e && s && (this._config.value = e), this._options.forEach(e => {
                    e.removeClass(i.selectedOption)
                }), this._placeholder.removeClass(i.placeholderHidden), this._config.multiple) {
                const e = this._config.value.map(e => {
                    const t = this._config.options.find(t => t.value === e);
                    return this._options.find(e => e.get().getAttribute("data-value") === t.value.toString()).addClass(i.selectedOption), t
                });
                return e.length && this._placeholder.addClass(i.placeholderHidden), void this._selectOptions(e, t)
            }
            const n = this._config.value ? this._config.options.find(e => e.value.toString() === this._config.value) : this._config.options[0];
            this._options.find(e => e.get().getAttribute("data-value") === n.value.toString()).addClass(i.selectedOption), this._placeholder.addClass(i.placeholderHidden), this._selectOption(n, t)
        }
        _selectOption(e, t) {
        ...
        _selectOptions(e, s) {
            this._label.setText(""), this._icons = e.map(e => {
                const s = new t("span", {
                        class: i.selectedLabel,
                        textContent: e.label
                    }),
                    n = new t(this._config.inlineIcon ? this._config.inlineIcon.cloneNode(!0) : "i", {
                        class: this._config.icon,
                        value: e.value
                    });
                return n.addEventListener("click", this._boundUnselectOption), s.append(n.get()), this._label.append(s.get()), n.get()
        ...
        _sortOptions(e) {
            this._options.forEach(t => {
                t.get().textContent.toLowerCase().startsWith(e.target.value.toLowerCase()) ? t.removeClass(i.optionHidden) : t.addClass(i.optionHidden)
            })
        }
    }
}();